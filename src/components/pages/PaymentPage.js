        ...
        <Grid container className={classes.mainGrid}>
          <Grid item md={6} className={classes.columnsGrid}>
            <Typography className={classes.serveceBelo}>
              Easy Way to Make online <span style={{ color: pallete.primaryPurple }}>
                Payments and Secure
              </span>
            </Typography>
            ...
            <Box className={classes.rectangleBox2}>
              ...
              <Paper className={classes.container}>
                <Grid container spacing={2}>
                  <Grid item xs={6}>
                    <Typography className={classes.BoxNormal}>Product name</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography className={classes.BoxNormal} align="right">00$</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography className={classes.BoxNormal}>Taxes and fees</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography align="right" className={classes.BoxNormal}>00$</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography className={classes.BoxBold} >Subtotal</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography align="right" className={classes.BoxBold}>00$</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography className={classes.BoxNormal}>Service tax</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography align="right" className={classes.BoxNormal}>00$</Typography>
                  </Grid>
                  ...
                  <Grid item xs={12}>
                    <Button onClick={handleOpen} variant="contained" className={classes.payNowButton}>
                      Pay Now
                    </Button>
                    <Modal
                      open={open}
                    ...
                    >
                      <Box className={classes.style}>
                        ...
                        />
                        <Typography style={{ alignSelf: 'center' }} className={classes.modalHeading} sx={{ mt: 2 }}>
                        ...
                        <Box className={classes.rectangleBox3}>
                          ...
                          <Paper >
                            <Grid container spacing={2}>
                              <Grid item xs={6}>
                                <Typography style={{ alignSelf: 'flex-start' }} >Order Review</Typography>
                              </Grid>
                              <Grid item xs={6}>
                                <img
                              ...
                              <Grid item xs={6}>
                                <Typography className={classes.BoxNormal}>Total</Typography>
                              </Grid>
                              <Grid item xs={6}>
                                <Typography align="right" className={classes.BoxNormal}>00$</Typography>
                              </Grid>
                          ...
                          <Button onClick={handleClose} variant="contained" className={classes.homePageBack}>
                            Back to Home Page
                          </Button>
                        </Box>
                      </Box>
